...
import com.dunvant.application.HorizontalListView;
...
import com.dunvant.application.beans.AgeGroupAttendanceBean;
import com.dunvant.application.beans.ChildPostsBean;
import com.dunvant.application.beans.ChildSuggestionBean;
import com.dunvant.application.beans.UserBean;
import com.dunvant.application.child.ChildAllCommentsReadScreen;
import com.dunvant.application.child.ChildPostViewScreen;
import com.dunvant.application.child.adapters.ChildPostTimeLineActivityAdapter;
import com.dunvant.application.child.adapters.ChildPostTimeLineScoreAdapter;
import com.dunvant.application.child.adapters.ChildSuggestionAdapter;
import com.dunvant.application.parent.ParentChildActivityStatsScreen;
import com.dunvant.application.parent.ParentChildReportScreen;
            ...
            public void onClick(View v) {
                if(Utilities.isNetworkAvailable(context)) {
                    if(childPostsBean.getChallengeAction().equalsIgnoreCase("approval_required_friend_reqst")){
                            ...
                            public void onClick(View v) {
                                ...
                                if (parentPasswordStr == null || parentPasswordStr.isEmpty()) {
                                    ...
                                    if (Utilities.isNetworkAvailable(context)) {
                                        ...
                                        PostWebServiceWithHeadersAsync postWebServiceAsync = new PostWebServiceWithHeadersAsync(context, nameValuePairList, ACCEPT_OR_REJECT_APPROVAL_REQUEST, com.dunvant.application.startModule.adapter.CoachPostAdapterNew.this, headers);
                        ...
                        PostWebServiceWithHeadersAsync postWebServiceAsync = new PostWebServiceWithHeadersAsync(context, nameValuePairList, ACCEPT_OR_REJECT_FRIEND, com.dunvant.application.startModule.adapter.CoachPostAdapterNew.this, headers);
                        postWebServiceAsync.execute(webServiceUrl);
                    }
                ...
                if(childPostsBean.getIsLikeByYou().equalsIgnoreCase("false")){
                    ...
                    if(childPostsBean.getLocalType().equalsIgnoreCase("timeline")){
                        if(childPostsBean.getApprovalStatus().equalsIgnoreCase("approval_required_timeline")){
                                ...
                                public void onClick(View v) {
                                    ...
                                    if(parentPasswordStr==null || parentPasswordStr.isEmpty()){
                                        ...
                                        if(Utilities.isNetworkAvailable(context)) {
                                            ...
                                            PostWebServiceWithHeadersAsync postWebServiceAsync = new PostWebServiceWithHeadersAsync(context, nameValuePairList, APPROVAL_TIMELINE, com.dunvant.application.startModule.adapter.CoachPostAdapterNew.this, headers);
                                            postWebServiceAsync.execute(webServiceUrl);
                                        }else{
                                            Toast.makeText(context, R.string.internet_not_available, Toast.LENGTH_SHORT).show();
                                        }
                            ...
                            PostWebServiceWithHeadersAsync postWebServiceAsync = new PostWebServiceWithHeadersAsync(context, nameValuePairList, LIKE_UNLIKE, com.dunvant.application.startModule.adapter.CoachPostAdapterNew.this, headers);
                            postWebServiceAsync.execute(webServiceUrl);
                        }
                    ...
                    public void onClick(View v) {
                        if (Utilities.isNetworkAvailable(context)) {
                            ...
                            if (childPostsBean.getChallengeIsShared().equalsIgnoreCase("1")) {
                                ...
                                PostWebServiceWithHeadersAsync postWebServiceAsync = new PostWebServiceWithHeadersAsync(context, nameValuePairList, POST_SHARE, com.dunvant.application.startModule.adapter.CoachPostAdapterNew.this, headers);
                                postWebServiceAsync.execute(webServiceUrl);
                            }
                        ...
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                ...
                                if (Utilities.isNetworkAvailable(context)) {
                                    ...
                                    PostWebServiceWithHeadersAsync postWebServiceAsync = new PostWebServiceWithHeadersAsync(context, nameValuePairList, POST_DELETE, com.dunvant.application.startModule.adapter.CoachPostAdapterNew.this, headers);
                                    postWebServiceAsync.execute(webServiceUrl);
                                } else {
                                    Toast.makeText(context, R.string.internet_not_available, Toast.LENGTH_SHORT).show();
                                }
            ...
            public void onClick(View v) {
                if(Utilities.isNetworkAvailable(context)) {
                    ...
                    if(childPostsBean.getChallengeChallengeStatus().equalsIgnoreCase("set_challenge")){
                        ...
                        PostWebServiceWithHeadersAsync postWebServiceAsync = new PostWebServiceWithHeadersAsync(context, nameValuePairList, ACCEPT_CHALLENGE, com.dunvant.application.startModule.adapter.CoachPostAdapterNew.this, headers);
                        postWebServiceAsync.execute(webServiceUrl);
                                ...
                                public void onClick(View v) {
                                    ...
                                    if(parentPasswordStr==null || parentPasswordStr.isEmpty()){
                                        ...
                                        if(Utilities.isNetworkAvailable(context)) {
                                            ...
                                            PostWebServiceWithHeadersAsync postWebServiceAsync = new PostWebServiceWithHeadersAsync(context, nameValuePairList, APPROVAL_CHALLENGE, com.dunvant.application.startModule.adapter.CoachPostAdapterNew.this, headers);
                                            postWebServiceAsync.execute(webServiceUrl);
                                        }else{
                                            Toast.makeText(context, R.string.internet_not_available, Toast.LENGTH_SHORT).show();
                                        }
...
//                    System.out.println("ingored_challenge_called");
                    ...
                    headers.add("X-access-uid:"+loggedInUser.getId());
                    headers.add("X-access-token:" + loggedInUser.getToken());
                    PostWebServiceWithHeadersAsync postWebServiceAsync = new PostWebServiceWithHeadersAsync(context, nameValuePairList, IGNORE_CHALLENGE, com.dunvant.application.startModule.adapter.CoachPostAdapterNew.this, headers);
                    postWebServiceAsync.execute(webServiceUrl);
