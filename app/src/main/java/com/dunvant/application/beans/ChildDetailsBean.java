...
public class ChildDetailsBean implements Serializable{
    ...
    private String childProfilePicUrl;
    ...
    public String getTotalScorePercentage() {
        return totalScorePercentage;
    }

    public void setTotalScorePercentage(String totalScorePercentage) {
        this.totalScorePercentage = totalScorePercentage;
    }

    public String getChildProfilePicUrl() {
        return childProfilePicUrl;
    }

    public void setChildProfilePicUrl(String childProfilePicUrl) {
        this.childProfilePicUrl = childProfilePicUrl;
    }
