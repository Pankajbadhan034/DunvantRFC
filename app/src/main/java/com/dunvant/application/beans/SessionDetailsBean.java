...
public class SessionDetailsBean implements Serializable{
    ...
    public void setSessionDetailsId(String sessionDetailsId) {
        this.sessionDetailsId = sessionDetailsId;
    }
    ...
    public String getBookingClose() {
        return bookingClose;
    }

    public void setBookingClose(String bookingClose) {
    ...
    public String getSessionsBooked() {
        return sessionsBooked;
    }

    public void setSessionsBooked(String sessionsBooked) {
